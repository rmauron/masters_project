...
projMulti3 <- addGeneIntegrationMatrix(
    ...
    reducedDims = "Harmony", #"LSI_Combined"
    seRNA = se_RNA_mousebrain_data,
    addToArrow = TRUE, #set TRUE to the Taonomy you want to add to the ArrowFiles
...
table(projMulti4@cellColData@listData[["predictedGroup_Un_3"]])
```
...
markersPeaks <- getMarkerFeatures(
    ...
    groupBy = "predictedGroup_Un_3", #feature to group by in proj@cellColData@listData[["xxxxxxx"]]
...
p <- plotBrowserTrack(
    ArchRProj = projMulti4, 
    groupBy = "predictedGroup_Un_3", #change group here
...
unique(projMulti3@cellColData@listData[["predictedGroup_Un_3"]])
```
