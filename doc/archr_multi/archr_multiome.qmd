...
for (i in 1:length(useGroups_list)) {
    ...
    nam <- gsub(" ", "", paste0("marker_pairwise", "_", useGroups_list[i])) #marker_pairwise for each iteration with cell names
    ...
    nam_significant <- gsub(" ", "", paste0("marker_pairwise_significant", "_", useGroups_list[i])) #marker_pairwise_significant for each iteration with cell names
    marker_significant <- c() #list of dataframes of marker_pairwise_significant
    ...
    ######## redo list of DF
    marker_significant <- append(nam_significant, list(marker_significant), 0) # append every dataframe to this list
