...
projMulti3 <- addCellColData(
    ArchRProj = projMulti3, 
    data = gsub(" ", "_", paste0(projMulti3@cellColData$Conditions, "_x_", projMulti3@cellColData$predictedGroup_Un_4)), 
...
projMulti3 <- addCellColData(
    ArchRProj = projMulti3, 
    data = gsub(" ", "_", paste0(projMulti3@cellColData$predictedGroup_Un_4, "_x_", projMulti3@cellColData$Conditions)), 
...
df_cond_cell <- cbind(df_cond_cell, projMulti3@cellColData@listData[["Sample"]]) #new
df_cond_cell <- setnames(df_cond_cell, c("CellType_Condition", "nCells", "Sample")) #new
