...
for (i in 1:length(useGroups_list)) {
    ...
    nam_significant <- nam_significant[((nam_significant$FDR <= 0.5) & (nam_significant$Log2FC >= 1)),] #& (nam_significant$Log2FC >= 1 | nam_significant$Log2FC <= 1 )),]
